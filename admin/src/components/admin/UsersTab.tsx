                                                            ...
                                                            {user.profile_photo ? (
                                                                <img 
                                                                    ...
                                                                    onError={(e) => {
                                                                        ...
                                                                        (e.target as HTMLImageElement).parentElement!.innerHTML = `<span class="text-primary fw-bold">${user.first_name ? user.first_name.charAt(0).toUpperCase() : 'U'}</span>`;
                                                                    }}
                                                                />
                                                            ) : (
                            ...
                            <div className="d-flex align-items-center mb-4">
                                <div className="avatar me-4 bg-light rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style={{ width: '80px', height: '80px', fontSize: '2rem' }}>
                                    {selectedUser.profile_photo ? (
                                        <img 
                                            src={getProfilePhotoUrl(selectedUser.profile_photo)} 
