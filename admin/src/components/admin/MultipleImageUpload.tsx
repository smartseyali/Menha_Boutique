...
const MultipleImageUpload: React.FC<MultipleImageUploadProps> = ({ 
  ...
  const getImageUrlWithBase = (imagePath: string) => {
    ...
    const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://menhaapi.smartseyali.app';
                ...
                <div style={{ position: 'relative', paddingBottom: '75%', overflow: 'hidden', borderRadius: '4px' }}>
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = `${import.meta.env.VITE_API_BASE_URL || 'https://menhaapi.smartseyali.app'}/assets/img/product/default.jpg`;
                    }}
                  />
                </div>
