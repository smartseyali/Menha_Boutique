...
const BannersTab = () => {
    ...
    const getImageUrl = (url: string) => {
        ...
        const baseUrl = import.meta.env.VITE_API_BASE_URL || 'https://menhaapi.smartseyali.app';
                                        ...
                                        <tr key={banner.id}>
                                            <td className="ps-4">
                                                {banner.type === 'video' || banner.image_url.endsWith('.mp4') ? (
                                                     <video src={getImageUrl(banner.image_url)} style={{height: '50px', width: '80px', objectFit: 'cover', borderRadius: '4px'}} muted />
                                                ) : (
                                                    <img src={getImageUrl(banner.image_url)} alt={banner.title} style={{height: '50px', width: '80px', objectFit: 'cover', borderRadius: '4px'}} />
                                                )}
                                            </td>
                                            <td>{banner.title}</td>
                                    ...
                                    {formData.image_url && (
                                        <div className="mt-2 p-2 border rounded bg-light text-center">
                                            {formData.type === 'video' || formData.image_url.endsWith('.mp4') ? (
                                                <video src={getImageUrl(formData.image_url)} controls style={{maxHeight: '200px', maxWidth: '100%'}} />
                                            ) : (
                                                <img src={getImageUrl(formData.image_url)} alt="Preview" style={{maxHeight: '200px', maxWidth: '100%', objectFit: 'contain'}} />
                                            )}
                                        </div>
                                    )}
                                </Form.Group>
